...
int About() {
	...
	gotoxy(D2_X_ABOUT + 13, D2_Y_ABOUT + 21);
	wcout << D2_HCMUS_1;
	gotoxy(D2_X_ABOUT + 13, D2_Y_ABOUT + 22);
	wcout << D2_HCMUS_2;
	gotoxy(D2_X_ABOUT + 13, D2_Y_ABOUT + 23);
	wcout << D2_HCMUS_3;
	gotoxy(D2_X_ABOUT + 13, D2_Y_ABOUT + 24);
	wcout << D2_HCMUS_4;
	gotoxy(D2_X_ABOUT + 13, D2_Y_ABOUT + 25);
	wcout << D2_HCMUS_5;
	gotoxy(D2_X_ABOUT + 13, D2_Y_ABOUT + 26);
	wcout << D2_HCMUS_6;
